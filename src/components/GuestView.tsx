    ...
    >
      ...
      <section className="bg-[#1e201e] rounded-2xl border border-[#D29B6C]/20 p-6 shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-row gap-3 items-center justify-center md:justify-end w-full md:w-auto">
            <a
              href={whatsappLink}
              target="_blank"
              rel="noreferrer"
              className="w-11 h-11 flex items-center justify-center bg-[#4a634e] text-white rounded-full hover:brightness-110 active:scale-95 transition-all cursor-pointer shadow-md"
            ...
            <a
              href={phoneLink}
              className="w-11 h-11 flex items-center justify-center border border-[#D29B6C] text-[#f6bb89] rounded-full hover:bg-neutral-800 active:scale-95 transition-all cursor-pointer shadow-md"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-11 h-11 flex items-center justify-center border border-[#4a85f6] text-[#8ab4f8] rounded-full hover:bg-[#4a85f6]/10 active:scale-95 transition-all cursor-pointer shadow-md"
